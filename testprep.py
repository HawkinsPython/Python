...
## 4
# print("First heat some water.\nThen grind some coffee beans.\nThen put a coffee filter in the coffee machine.\nNow put the ground beans in the coffee maker.\nLet the hot water flow through the beans.")
...
# print("code will combine the variables but will not add them, because you cannot do any math to a string")
