...
# firstn = input("Please enter a first name. ")
# lastn = input("Please enter a lastn name. ")
# print(f"Maybe someone is named: {firstn} {lastn}.")

# print("hello!")
# colortype = input("What is your favorite color? ")
# print(f"{colortype} is a good color.")

# animaltype = input("Name an animal. ")
# planttype = input("Name a Plant. ")
# print(f"The {animaltype} eats {planttype} every day")
...
# c = a + b
# print("I can add them. Here's what I got...")
# print(c)
